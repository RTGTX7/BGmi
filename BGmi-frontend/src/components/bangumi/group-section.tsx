...
export default function BangumiGroupSection({
  ...
  return (
    <Box
      ...
      rounded="3xl"
      borderWidth="1px"
      borderColor={isDark ? 'whiteAlpha.090' : 'rgba(255,255,255,0.52)'}
      bg={isDark ? 'rgba(15,20,31,0.36)' : 'rgba(244,250,252,0.36)'}
      boxShadow={
        isDark
      ...
      _hover={{
        ...
        bg: isDark ? 'rgba(15,20,31,0.40)' : 'rgba(244,250,252,0.4)',
      }}
    >
      <Flex
        gap={{ base: '3', md: '4' }}
        ...
        <Stack spacing="1.5" minW="0" flex="1">
          <HStack spacing="2.5" align="center" flexWrap="wrap">
            ...
            <Badge
              ...
              fontSize="10px"
              textTransform="none"
              bg={isDark ? 'rgba(255,255,255,0.08)' : 'rgba(255,255,255,0.58)'}
              color={isDark ? 'whiteAlpha.880' : '#486070'}
              borderWidth="1px"
          ...
          {subtitle ? (
            <Text fontSize={{ base: 'xs', md: 'sm' }} color={isDark ? 'whiteAlpha.700' : 'rgba(60,78,92,0.78)'}>
              {subtitle}
            </Text>
          ) : null}
        </Stack>
      ...
      <Box
        ...
        mt="5"
        gridTemplateColumns="repeat(auto-fit, minmax(min(100%, 13.75rem), 13.75rem))"
        gap={{ md: 4, xl: 5 }}
        alignItems="start"
      ...
      >
        {desktopItems.map(bangumi => (
          <Box key={bangumi.id} w="13.75rem" maxW="13.75rem">
            <BangumiCard bangumiData={bangumi} />
          </Box>
        ))}
      </Box>
